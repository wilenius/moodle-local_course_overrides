...
/**
 * Form for creating bulk user quiz overrides.
 *
 * @package     local_course_overrides
 * @copyright   2025 Course Overrides Plugin
 * @license     https://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class bulk_override_form extends moodleform {
    ...
    protected function definition() {
        ...
        $users = $DB->get_records_sql("
              ...
              ORDER BY $sort
                ", array_merge($userfieldsql->params, $enrolledjoin->params, $sortparams));
        ...
        $mform->addElement('static', 'bulkinfo', '',
            get_string('bulkoverrideinfo', 'local_course_overrides'));

        $mform->addElement('checkbox', 'updateexisting',
            get_string('updateexisting', 'local_course_overrides'));
        $mform->setType('updateexisting', PARAM_BOOL);
        $mform->addHelpButton('updateexisting', 'updateexisting', 'local_course_overrides');
